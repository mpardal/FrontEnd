        ...
        <div className="bg-gray-200 h-screen pt-10">
            ...
            >
                ...
                <label className="m-3">
                    ...
                    <input type="number" name="number" className="w-1/2 mx-auto border border-slate-400 m-1"/>
                </label>
                <label className="m-3">
                    Votre commentaire: <br/>
                    <textarea name="message" className="p-1 w-1/2 mx-auto border border-slate-400 m-1"/>
                </label>
