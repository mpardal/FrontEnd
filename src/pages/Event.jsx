...
function Event() {
    ...
    const valueText = 'Bonjour,\n' +
        'Je souhaiterai réserver une séance photo pour la prestation "J\'immortalise l\'événement"\n' +
        'Merci par avance'
        ...
        <div className="bg-gray-200 h-screen pt-10">
            ...
            >
                ...
                <label className="m-3">
                    ...
                    <input type="tel" name="number" className="w-1/2 mx-auto border border-slate-400 m-1" minLength="10" required/>
                </label>
                <label className="m-3">
